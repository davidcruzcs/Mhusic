...
class AppDelegate: UIResponder, UIApplicationDelegate, SPTAudioStreamingDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        SPTAuth.defaultInstance().clientID = "9439315b7013474a9f83e3048d1eb45d"
        ...
        if SPTAuth.defaultInstance().canHandleURL(url) {
            ...
            SPTAuth.defaultInstance().handleAuthCallbackWithTriggeredAuthURL(url, callback: { (error, session) in
                ...
                if error != nil {
                    ...
                    do {
                        try self.spotifyPlayer.startWithClientId(SPTAuth.defaultInstance().clientID)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.dhamova.Mhusic" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Mhusic", withExtension: "momd")!
